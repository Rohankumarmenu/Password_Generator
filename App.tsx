...
const App = () => {
  ...
  const generatePasswordString = (passowrdLength: number) => {
    ...
    const lowerCaseChars = 'abcdefghijklmnopwrstuvwxyz';
    ...
    const password_result = createPassword(characterList, passowrdLength)

    setPassword(password_result)
      ...
      <SafeAreaView>
        <View style={styles.formContainer}>
          ...
          <Formik
            ...
            onSubmit={values => {
              generatePasswordString(+values.passwordLength) //converft it into int"
            }}
          >
            {({
              values,
